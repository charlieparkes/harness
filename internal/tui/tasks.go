...
import (
	...
	"github.com/charlieparkes/harness/internal/reltime"
	"github.com/charlieparkes/harness/internal/tui/styles"
)
...
func (i taskItem) descriptionAt(now time.Time) string {
	...
	if rel := reltime.RelativeTime(i.task.CreatedAt, now); rel != "" {
