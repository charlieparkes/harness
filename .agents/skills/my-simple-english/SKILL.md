...
| 5.2 | One instruction per sentence, unless two actions happen at the same time. Keep related sentences in one paragraph. Do not put each sentence on a new line. |
...
| Rule | Instruction |
|---|---|
| 6.1 | Give information gradually: one new fact per sentence. Keep related sentences in one paragraph. Do not put each sentence on a new line. |
